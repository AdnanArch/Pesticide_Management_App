...
--
-- Dumping data for table `account_holder_bill_cart`
--

LOCK TABLES `account_holder_bill_cart` WRITE;
/*!40000 ALTER TABLE `account_holder_bill_cart` DISABLE KEYS */;
INSERT INTO `account_holder_bill_cart` VALUES (223,116,'Initial',882978,1,'Pending'),(224,117,'FFC-0004',20,11600,'Pending');
/*!40000 ALTER TABLE `account_holder_bill_cart` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `account_holder_bills`
--

LOCK TABLES `account_holder_bills` WRITE;
/*!40000 ALTER TABLE `account_holder_bills` DISABLE KEYS */;
INSERT INTO `account_holder_bills` VALUES (116,3650118477867,'2024-03-10 07:25:00',882978,'0000-000000','Pending'),(117,3650194909667,'2024-03-18 21:29:34',232000,'','Pending');
/*!40000 ALTER TABLE `account_holder_bills` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `account_holders` VALUES (3650118425011,'Haji Sultan, 5/11-L','Chak No. 5/11-L','0346-8699678',0),(3650118477867,'Ch. Sajjad Cheema, 6/11-L','Chak No. 6/11-L','0300-7628083',0),(3650118734843,'Ch. Shoaib Hussain Boobak, 6/11-L','Chak No. 6/11-L','0300-8035611',0),(3650128878217,'Rajput Traders, Ali Manzoor, Ada Khui','Ada Khui','0341-6973176',0),(3650137147363,'Inam & Co. Rana Ikram Waris, Chichawatni','Ghalla Mandi, Chichawatni','0307-6093375',0),(3650176137813,'Ch. Ashfaq, Chandni Chowk','Chak No. 108/7-R','0323-7180100',0),(3650194909667,'Ch. Atif Latif, 6/11-L','Chak No. 6/11-L','0345-7446242',0),(3650249435399,'Junaid Traders, Harappa Station','Harappa Station','0300-7836985',0);
...
INSERT INTO `companies` VALUES (10,'ENGRO FERTILIZERS LIMITED','Engro Fertilizers Limited, 6th Floor, Harbor Front Building, Marine Drive, Clifton','021111211211'),(11,'FAUJI FERTILIZER COMPANY LIMITED','Lahore Trade Center, 11 Shahrah-e-Sanat-o-Tijarat, Lahore. NTN: 1435809-3','04236369137'),(12,'FAUJI FERTILIZER BIN QASIM LIMITED','FFBL Tower, Plot No C1/C2 Jinnah Boulevard, Sector B, DHA Phase II, Islamabad, NTN: 0657297-9','0518763325'),(13,'FATIMA FERTILIZER COMPANY LIMITED','E-110, Khayaban-e-Jinnah, Lahore. NTN: 1791532-5','042111328462'),(14,'UNITED AGRO FERTILIZERS','NA','NA'),(15,'SAFI FERTILIZER','NA','NA'),(16,'ALLIED KASHTKAR','NA','NA'),(17,'Al-Makkah Traders, Harappa','NA','NA'),(18,'FOUR SEASON CHEMICALS','1-KM, Mao Mubarak Road, Rahim Yar Khan','0685901065'),(19,'ALLURE CHEMICALS','326-Alquraish Housing Scheme, Sher Shah Road Multan','03009691435'),(20,'PATRON CHEMICALS','101/4 Industrial Estate Multan','03455565797');
...
INSERT INTO `company_accounts` VALUES ('0000-000000','AL-MAKKAH TRADERS','CASH (DAY BOOK)',933079),('PK28MCIB0281004759250002','MUHAMMAD NAEEM','MCIB ISLAMIC',100000),('PK41MEZN0012330104057411','MUHAMMAD NAEEM','MEEZAN BANK LIMITED',2254135),('PK71HABB0018297900611701','ABDULLAH NAEEM CORPORATION','HBL/1829 SAVINGS',32822825),('PK73MUCB0592353121006101','MUHAMMAD NAEEM','MCB',36760),('PK97HABB0018297900738303','MUHAMMAD NAEEM','HBL/1829 CURRENT',780083);
...
INSERT INTO `company_transactions` VALUES (233,'PK41MEZN0012330104057411','2024-03-09 23:32:41','Opening Balance','credit',2254135),(234,'PK28MCIB0281004759250002','2024-03-09 23:38:59','Opening Balance','credit',100000),(235,'PK97HABB0018297900738303','2024-03-09 23:42:27','Opening Balance','credit',780083),(236,'PK71HABB0018297900611701','2024-03-09 23:47:57','Opening Balance','credit',32822825),(237,'PK73MUCB0592353121006101','2024-03-10 00:12:05','Opening Balance','credit',36761),(240,'0000-000000','2024-03-10 03:55:10','Opening Balance','credit',100),(241,'0000-000000','2024-03-10 04:16:37','CD','credit',100),(242,'0000-000000','2024-03-10 05:16:44','CD','credit',882878),(243,'0000-000000','2024-03-10 07:25:00','Initial Payment Q 882978.0 @ 1.0','credit',50000),(244,'0000-000000','2024-03-10 07:28:49','CD','credit',1);
...
--
-- Dumping data for table `empty_bills`
--

LOCK TABLES `empty_bills` WRITE;
/*!40000 ALTER TABLE `empty_bills` DISABLE KEYS */;
INSERT INTO `empty_bills` VALUES (30,'emp_30',3650118477867,'2024-03-10 04:16:37',100,'credit'),(31,'emp_31',3650118477867,'2024-03-10 05:16:44',882878,'credit'),(32,'emp_32',3650118477867,'2024-03-10 07:28:49',1,'credit');
/*!40000 ALTER TABLE `empty_bills` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `holder_debit_credit`
--

LOCK TABLES `holder_debit_credit` WRITE;
/*!40000 ALTER TABLE `holder_debit_credit` DISABLE KEYS */;
INSERT INTO `holder_debit_credit` VALUES (121,NULL,NULL,3650118477867,'2024-03-09 22:42:18','debit','Closing balance.',882978),(123,'emp_30',NULL,3650118477867,'2024-03-10 04:16:37','credit','CD',100),(124,NULL,NULL,3650176137813,'2024-03-10 05:06:48','credit','Closing balance.',26000),(125,'emp_31',NULL,3650118477867,'2024-03-10 05:16:44','credit','CD',882878),(126,NULL,NULL,3650194909667,'2024-03-10 05:40:15','credit','Closing balance.',184718),(127,NULL,NULL,3650118734843,'2024-03-10 06:04:22','credit','Closing balance.',5510),(128,NULL,NULL,3650128878217,'2024-03-10 06:09:04','credit','Closing balance.',0),(129,NULL,NULL,3650137147363,'2024-03-10 06:12:28','credit','Closing balance.',0),(130,NULL,NULL,3650118425011,'2024-03-10 07:18:15','credit','Closing balance.',0),(131,NULL,116,3650118477867,'2024-03-10 07:25:00','debit','Initial Payment Q 882978.0 @ 1.0',832978),(132,'emp_32',NULL,3650118477867,'2024-03-10 07:28:49','credit','CD',1),(133,NULL,NULL,3650249435399,'2024-03-10 07:32:41','credit','Closing balance.',81000),(134,NULL,117,3650194909667,'2024-03-18 21:29:34','debit','SONA DAP 50KG Q 20.0 @ 11600.0',232000);
/*!40000 ALTER TABLE `holder_debit_credit` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `over_invoiced_bills`
--

LOCK TABLES `over_invoiced_bills` WRITE;
/*!40000 ALTER TABLE `over_invoiced_bills` DISABLE KEYS */;
/*!40000 ALTER TABLE `over_invoiced_bills` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `petty_cash_payments`
--

LOCK TABLES `petty_cash_payments` WRITE;
/*!40000 ALTER TABLE `petty_cash_payments` DISABLE KEYS */;
/*!40000 ALTER TABLE `petty_cash_payments` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `product_brand` VALUES (10,10,'ENGRO'),(11,11,'FFC-SONA'),(12,12,'FFC-SONA'),(13,11,'FFC'),(14,13,'SARSABZ'),(15,13,'PAKARAB'),(16,13,'BABBAR SHER'),(17,14,'7-STAR'),(18,15,'SAFI'),(19,16,'ALLIED KASHTKAR'),(20,17,'NA'),(21,18,'FOUR SEASON'),(22,19,'ALLURE CHEMICALS'),(23,20,'PATRON');
...
INSERT INTO `product_category` VALUES (5,'Fertilizer'),(6,'Pesticide');
...
INSERT INTO `products` VALUES ('Allure-0001',6,22,'SULPHUR 1KG',650),('EFL-0001',5,10,'ENGRO UREA',4648),('EFL-0002',5,10,'ENGRO DAP',13300),('EFL-0003',5,10,'ENGRO NP PLUS',7836),('EFL-0004',5,10,'ENGRO ZORAWAR',12607),('EFL-0005',5,10,'ENGRO ZABARDAST UREA',5799),('FFC-0001',5,11,'SONA UREA-P',3767),('FFC-0002',5,11,'SONA UREA-NEEM COATED',4017),('FFC-0003',5,11,'SONA UREA-G',5331),('FFC-0004',5,12,'SONA DAP 50KG',13000),('FFC-0005',5,13,'FFC-DAP',13000),('FFC-0006',5,13,'FFC-SOP 50KG',12565),('FFC-0007',5,13,'FFC-SOP 25KG',6398),('FFC-0008',5,13,'FFC-MOP',8800),('FFC-0009',5,12,'SONA DAP 25KG',6640),('FFL-0001',5,14,'SARSABZ UREA',3839),('FFL-0002',5,14,'SARSABZ DAP',13000),('FFL-0003',5,14,'NP 50KG',8000),('FFL-0004',5,14,'CAN-G',3635),('FFL-0005',5,15,'CAN-F PAKARAB',3615),('FFL-0006',5,14,'NP 25KG',4400),('FFL-0007',5,16,'BABBAR SHER UREA',4095),('FFL-0008',5,16,'BABBAR SHER DAP',13300),('Four-0001',6,21,'SEGA PEST CLEAR LTR',1450),('Initial',5,20,'Initial Payment',1),('KASHT-0001',5,19,'KASHTKAR MOP',9200),('PAT-0001',6,23,'ACETOCHLOR LTR',1450),('SAFI-0001',5,18,'SAFI-SSP',3000),('UAF-0001',5,17,'7STAR-AMMONIUM SULPHATE',4200);
...
--
-- Dumping data for table `purchase_request_cart`
--

LOCK TABLES `purchase_request_cart` WRITE;
/*!40000 ALTER TABLE `purchase_request_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `purchase_request_cart` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `stock` VALUES ('Allure-0001',0,0),('EFL-0001',0,0),('EFL-0002',0,0),('EFL-0003',0,0),('EFL-0004',0,0),('EFL-0005',0,0),('FFC-0001',0,0),('FFC-0002',0,0),('FFC-0003',0,0),('FFC-0004',0,0),('FFC-0005',0,0),('FFC-0006',0,0),('FFC-0007',0,0),('FFC-0008',0,0),('FFC-0009',0,0),('FFL-0001',0,0),('FFL-0002',0,0),('FFL-0003',0,0),('FFL-0004',0,0),('FFL-0005',0,0),('FFL-0006',0,0),('FFL-0007',0,0),('FFL-0008',0,0),('Four-0001',0,0),('Initial',0,0),('KASHT-0001',0,0),('PAT-0001',0,0),('SAFI-0001',0,0),('UAF-0001',0,0);
...
--
-- Dumping data for table `walk_in_bill_details`
--

LOCK TABLES `walk_in_bill_details` WRITE;
/*!40000 ALTER TABLE `walk_in_bill_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `walk_in_bill_details` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `walk_in_bills`
--

LOCK TABLES `walk_in_bills` WRITE;
/*!40000 ALTER TABLE `walk_in_bills` DISABLE KEYS */;
/*!40000 ALTER TABLE `walk_in_bills` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-03-19 20:45:02
