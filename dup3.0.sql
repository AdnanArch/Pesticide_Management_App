CREATE DATABASE  IF NOT EXISTS `al_makkah_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `al_makkah_db`;
...
CREATE TABLE `account_holder_bill_cart` (
                                            ...
                                            `p_status` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
                                            PRIMARY KEY (`cart_id`),
...
CREATE TABLE `account_holder_bills` (
                                        ...
                                        `bill_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
                                        PRIMARY KEY (`bill_id`),
...
--
-- Temporary view structure for view `account_holder_report_view`
--

DROP TABLE IF EXISTS `account_holder_report_view`;
/*!50001 DROP VIEW IF EXISTS `account_holder_report_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `account_holder_report_view` AS SELECT
 1 AS `holder_name`,
 1 AS `is_retailer`,
...
CREATE TABLE `company_transactions` (
                                        ...
                                        `trans_description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                        `transaction_type` enum('debit','credit') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `empty_bills` (
                               ...
                               `emp_bill_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                               `cnic_no` bigint NOT NULL,
                               `bill_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
                               `total_amount` double NOT NULL,
                               `payment_type` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                               `payment_status` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Completed',
                               PRIMARY KEY (`id`),
...
CREATE TABLE `holder_debit_credit` (
                                       ...
                                       `transaction_kind` enum('debit','credit') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                       `trans_description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                       `amount` double NOT NULL,
                                       ...
                                       CONSTRAINT `fk_pr_id` FOREIGN KEY (`request_id`) REFERENCES `purchase_requests` (`request_id`)
...
CREATE TABLE `petty_cash_payments` (
                                       ...
                                       `payment_description` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                       `amount` double NOT NULL,
...
CREATE TABLE `product_ledger` (
                                  `transaction_id` int NOT NULL AUTO_INCREMENT,
                                  `product_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                  `transaction_type` enum('a','s') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                  `quantity` int NOT NULL,
                                  `location_type` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
                                  `transaction_date` datetime DEFAULT CURRENT_TIMESTAMP,
                                  PRIMARY KEY (`transaction_id`),
                                  KEY `product_code` (`product_code`),
                                  CONSTRAINT `product_ledger_ibfk_1` FOREIGN KEY (`product_code`) REFERENCES `products` (`product_code`)
...
CREATE TABLE `purchase_request_cart` (
                                         ...
                                         `quantity` float NOT NULL,
                                         `amount` double NOT NULL,
                                         `p_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
                                         PRIMARY KEY (`cart_id`),
...
CREATE TABLE `purchase_requests` (
                                     ...
                                     `total_amount` double NOT NULL,
                                     `request_type` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `stock_arrivals` (
                                  ...
                                  `vehicle_no` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `driver_no` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `product_code` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                  PRIMARY KEY (`id`),
...
--
-- Temporary view structure for view `stock_report_view`
--

DROP TABLE IF EXISTS `stock_report_view`;
/*!50001 DROP VIEW IF EXISTS `stock_report_view`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `stock_report_view` AS SELECT
 1 AS `product_code`,
 1 AS `product_name`,
 1 AS `warehouse_quantity`,
 1 AS `shop_quantity`*/;
...
CREATE TABLE `stock_transfer` (
                                  ...
                                  `from_place` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                  `to_place` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `walk_in_bills` (
                                 ...
                                 `total_amount` double NOT NULL,
                                 `payment_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
                                 `bill_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Pending',
                                 PRIMARY KEY (`bill_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
/*!50003 DROP FUNCTION IF EXISTS `generate_unique_13_digit_number` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `generate_unique_13_digit_number`(tableName VARCHAR(255), columnName VARCHAR(255)) RETURNS bigint
    READS SQL DATA
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `getCompanyId`(productName VARCHAR(30)) RETURNS int
    DETERMINISTIC
BEGIN
...
-- Call sp_create_account_holder to ensure the company is registered as an account holder
CALL sp_create_account_holder(
        p_company_name,
        generate_unique_13_digit_number('account_holders', 'cnic_no'), -- No CNIC for a company, so passing NULL
        p_address,
        p_phone,
        2, -- Assuming companies are not retailers
        0, -- Initial balance set to 0
        v_success -- Output parameter to capture success status
    );

-- If sp_create_account_holder failed, rollback but continue executing the rest of the procedure
...
-- Record the initial warehouse quantity in the product_ledger as an 'arrival' transaction
IF p_warehouse_quantity > 0 THEN
        INSERT INTO product_ledger (product_code, transaction_type, quantity, location_type, description)
        VALUES (p_product_code, 'a', p_warehouse_quantity, 'w', 'Initial stock in warehouse');
END IF;

    -- Record the initial shop quantity in the product_ledger as an 'arrival' transaction
    IF p_shop_quantity > 0 THEN
        INSERT INTO product_ledger (product_code, transaction_type, quantity, location_type, description)
        VALUES (p_product_code, 'a', p_shop_quantity, 's', 'Initial stock in shop');
END IF;
...
VALUES (p_account_no, CONCAT('Paid pending amount for p-order ', p_order_no), 'debit', p_paid_amount);

SELECT ordered_from INTO companyName FROM pending_order_payments_view WHERE request_id = p_order_no LIMIT 1;

SELECT cnic_no INTO cnic FROM account_holders WHERE holder_name = companyName;

INSERT INTO holder_debit_credit (request_id, cnic_no, t_date, transaction_kind, trans_description, amount)
VALUES (p_order_no, cnic, NOW(), 'credit', CONCAT('Paid pending amount for ', p_order_no), p_paid_amount);
...
BEGIN
    ...
    -- Error handling for SQL exceptions and warnings
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
SET p_success = FALSE;
...
-- Check if an account holder with the same CNIC number or holder name already exists
SELECT COUNT(*) INTO v_existing_count
FROM account_holders
WHERE cnic_no = p_cnic_no OR holder_name = p_holder_name;

IF v_existing_count = 0 THEN
        -- Insert a new account holder into the table
        ...
        IF ROW_COUNT() = 1 THEN
            -- Insert into holder_debit_credit with appropriate transaction type and amount
...
END IF;
ELSE
        -- If the account holder already exists, rollback and set success to FALSE
        ROLLBACK;
        SET p_success = FALSE;
END IF;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_create_purchase_request_with_company` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_create_purchase_request_with_company`(
    IN cartItems JSON,
...
BEGIN
    ...
    DECLARE lastRequestId INT; -- To store the last inserted request_id
    DECLARE resultSuccess BOOLEAN DEFAULT TRUE; -- Variable to track sp_insert_purchase_request_cart success
    DECLARE cnic BIGINT; -- To store the CNIC
...
-- Get the CNIC from the account_holders table
SELECT cnic_no INTO cnic
FROM account_holders
WHERE holder_name = companyName;

-- Insert data into the purchase request table
BEGIN
        DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
BEGIN
            SET success := FALSE;
...
END;
    ...
    -- Insert debit entry for the total amount into holder_debit_credit
INSERT INTO holder_debit_credit (request_id, cnic_no, t_date, transaction_kind, trans_description, amount)
VALUES (lastRequestId, cnic, NOW(), 'debit', CONCAT('Total bill for ', requestType, ' of ', p_description), totalAmount);

-- Insert credit entry for the paid amount if > 0 into holder_debit_credit
IF paidAmount > 0 THEN
        INSERT INTO holder_debit_credit (request_id, cnic_no, t_date, transaction_kind, trans_description, amount)
        VALUES (lastRequestId, cnic, NOW(), 'credit', CONCAT('Paid amount for ', requestType, ' of ', p_description), paidAmount);

INSERT INTO company_transactions (account_no, transaction_date, trans_description, transaction_type, amount)
VALUES (accountNo, NOW(), CONCAT('Paid for ', requestType, ' of ', p_description, ' to ', companyName, ' by ', paymentType), 'debit', paidAmount);
END IF;

    -- Insert items into the purchase request cart
...
SET success = success AND @resultSuccess;
    ...
    -- Commit or Rollback the transaction based on the success
    IF success THEN
        COMMIT;
ELSE
        ROLLBACK;
...
SELECT holder_name INTO accountHolderName
FROM account_holders
WHERE cnic_no = sourceId;
...
END;
    ...
    -- Insert debit entry for the total amount into holder_debit_credit
INSERT INTO holder_debit_credit (request_id, cnic_no, t_date, transaction_kind, trans_description, amount)
VALUES (lastRequestId, cnic, NOW(), 'debit', CONCAT('Total bill for purchase of ', p_description), totalAmount);

-- Insert credit entry for the paid amount if > 0 into holder_debit_credit
IF paidAmount > 0 THEN
        INSERT INTO holder_debit_credit (request_id, cnic_no, t_date, transaction_kind, trans_description, amount)
        VALUES (lastRequestId, cnic, NOW(), 'credit', CONCAT('Paid amount for purchase of ', p_description), paidAmount);
END IF;
...
SET @lastBillId = LAST_INSERT_ID();
    ...
    WHILE v_i < v_itemCount DO
			...
			SET v_quantity = CAST(REPLACE(JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', v_i, '].quantity.value'))), ',', '') AS FLOAT);
			SET v_amount = CAST(REPLACE(JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', v_i, '].pricePerUnit.value'))), ',', '') AS DOUBLE);
...
BEGIN
    SET result = FALSE;
DELETE FROM holder_debit_credit WHERE cnic_no = p_cnic_no;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_disable_account_holder` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_disable_account_holder`(IN p_cnic VARCHAR(255), OUT p_result BOOLEAN)
BEGIN
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
        -- error occurred, set result to false
        SET p_result = FALSE;
END;

    -- Update the account holder's status to disabled (assuming you have a column 'is_active' for this purpose)
UPDATE account_holders
SET is_active = FALSE
WHERE cnic_no = p_cnic;
...
SELECT
    ...
    ah.cnic_no,
    ah.address,
    ah.is_active AS is_active,
    ah.phone AS contact,
    ah.is_retailer AS is_retailer,
    IFNULL(
            CASE
                WHEN balances.balance < 0 THEN 'Credit'
                ELSE 'Debit'
                END,
            'Credit'
    ) AS transaction_type,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_bookings_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_bookings_report`()
BEGIN
SELECT
    prc.product_code AS productCode,
    prc.quantity AS orderedQuantity,
    GETLEFTQUANTITY(MIN(pr.request_id), prc.product_code) AS leftQuantity, -- Using MIN to satisfy ONLY_FULL_GROUP_BY
    prv.ordered_from AS orderedFrom,
    pr.request_type AS requestType
FROM
    purchase_request_cart prc
        INNER JOIN
    purchase_requests pr ON prc.request_id = pr.request_id
        INNER JOIN
    purchase_requests_view prv ON prc.request_id = prv.request_id
-- AND prc.product_code = prv.product_name
GROUP BY
    prc.product_code, prc.quantity, prv.ordered_from, pr.request_type
ORDER BY
    prc.product_code;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_pending_cheques` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_pending_cheques`()
BEGIN
SELECT
    emp_bill_id AS cheque_no,
...
BEGIN
    -- SELECT CONCAT_WS(' -> ', product_name, product_code) AS product_code FROM products;
...
BEGIN
SELECT p.product_code, p.product_name, pb.brand_name AS brand, c.company_name AS company, p.price
FROM products p
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_product_info` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_product_info`()
BEGIN
    -- Declare variables to store product info
    DECLARE productCode VARCHAR(30);
    DECLARE orderedQuantity DOUBLE;
    DECLARE leftQuantity DOUBLE;
    DECLARE orderedFrom VARCHAR(255); -- Assuming the datatype of the ordered_from attribute
    DECLARE requestType VARCHAR(30); -- Assuming the datatype of the request_type attribute

    -- Fetch product info for pending purchase requests
SELECT
    prc.product_code,
    prc.quantity AS ordered_quantity,
    getLeftQuantity(pr.request_id, prc.product_code) AS left_quantity,
    prv.ordered_from,
    pr.request_type
INTO
    productCode, orderedQuantity, leftQuantity, orderedFrom, requestType
FROM
    purchase_request_cart prc
        INNER JOIN
    purchase_requests pr ON prc.request_id = pr.request_id
        INNER JOIN
    purchase_requests_view prv ON pr.request_id = prv.request_id
WHERE
    pr.order_status = 'Pending';

-- Output the product info
SELECT productCode, orderedQuantity, leftQuantity, orderedFrom, requestType;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_product_names` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_product_names`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_shop_stock_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_shop_stock_report`(
    IN p_product_name VARCHAR(30),
    IN place VARCHAR(10)
)
BEGIN
    DECLARE p_product_code VARCHAR(30);
...
-- Select shop stock report
SELECT
    DATE_FORMAT(transaction_date, '%d-%m-%Y') AS transaction_date,
    description,
    CASE WHEN transaction_type = 'a' THEN quantity ELSE 0 END AS arrival,
    CASE WHEN transaction_type = 's' THEN quantity ELSE 0 END AS sale,
    SUM(CASE WHEN transaction_type = 'a' THEN quantity ELSE -quantity END)
        OVER (ORDER BY transaction_date) AS balance
FROM
    product_ledger
WHERE
    product_code = p_product_code AND location_type = place
ORDER BY
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_software_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_software_password`()
BEGIN
SELECT
    `password`
FROM
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_stock_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_stock_report`(
    IN p_product_name VARCHAR(30),
    IN place VARCHAR(1)
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_get_warehouse_stock_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_warehouse_stock_report`(
    IN p_product_name VARCHAR(30),
    OUT result BOOLEAN
)
BEGIN
    DECLARE p_product_code INT;
...
FROM
    product_ledger
WHERE
    product_code = p_product_code AND
    location_type = 'w'
ORDER BY
    transaction_date ASC;
...
SET v_bill_id = LAST_INSERT_ID();
    ...
    WHILE i < JSON_LENGTH(p_cart_items) DO
            ...
            VALUES (v_bill_id,
                    ...
                    CAST(REPLACE(JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', i, '].quantity.value'))), ',', '') AS FLOAT),
                    CAST(REPLACE(JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', i, '].pricePerUnit.value'))), ',', '') AS DOUBLE));
            SET i = i + 1;
END WHILE;

INSERT INTO holder_debit_credit (bill_id, cnic_no, transaction_kind, trans_description, amount)
VALUES (v_bill_id, p_holder_no, 'credit', p_description, p_total_bill);

IF p_paid_amount > 0 THEN
		INSERT INTO holder_debit_credit (bill_id, cnic_no, transaction_kind, trans_description, amount)
		VALUES (v_bill_id, p_holder_no, 'debit', p_description, p_paid_amount);
END IF;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_empty_bill`(
    ...
    IN p_payment_status VARCHAR(15),
    OUT result BOOLEAN
)
BEGIN
...
SET p_emp_bill_id = NULL;
    ...
    SET @v_transaction_type = IF(p_payment_type = 'debit', 'credit', 'debit');

    -- Insert into empty_bills table
INSERT INTO empty_bills (cnic_no, total_amount, payment_type, payment_status)
VALUES (p_holder_id, p_amount, p_payment_type, p_payment_status);

-- Retrieve the emp_bill_id for the last inserted row
SELECT emp_bill_id INTO id_out
FROM empty_bills
...
VALUES (p_emp_bill_id, p_holder_id, @v_transaction_type, p_description, p_amount);

-- Check if payment status is not pending, then proceed with updating company_transactions and account balance
IF p_payment_status != 'pending' THEN
        -- Insert into company_transactions table
        INSERT INTO company_transactions (account_no, transaction_date, trans_description, transaction_type, amount)
        VALUES (p_account_no, NOW(), p_description, p_payment_type, p_amount);

        -- Update company_accounts balance
UPDATE company_accounts
SET balance = balance + IF(p_payment_type = 'debit', -p_amount, p_amount)
WHERE account_no = p_account_no;
END IF;
...
-- Set result to TRUE as the transaction was successful
SET result = TRUE;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_insert_purchase_return` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_purchase_return`(
	IN p_holderNo BIGINT,
    IN p_accountNumber VARCHAR(50),
    IN p_totalAmount DOUBLE,
    IN p_cart_items TEXT,
...
BEGIN
    ...
    DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
        -- SQL exception occurred, set result to false
        SET p_result = FALSE;
END;
    ...
    WHILE i < JSON_LENGTH(p_cart_items) DO
		SET @product_code = JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', i, '].productCode.value')));
		SET @quantity = CAST(REPLACE(JSON_UNQUOTE(JSON_EXTRACT(p_cart_items, CONCAT('$[', i, '].quantity.value'))), ',', '') AS FLOAT);
UPDATE stock SET shop_quantity = shop_quantity + @quantity WHERE product_code = @product_code;
SET i = i + 1;
END WHILE;

    -- Insert Debit entry of purchase in company account no with description
INSERT INTO company_transactions(account_no, trans_description, transaction_type, amount)
VALUES (p_accountNumber, CONCAT_WS(' ', 'Purchase return', p_description), 'debit', p_totalAmount);

-- Insert Credit entry of purchase in account holder with description
INSERT INTO holder_debit_credit(cnic_no, trans_description, transaction_kind, amount)
VALUES (p_holderNo, CONCAT_WS(' ', 'Purchase return', p_description), 'credit', p_totalAmount);

INSERT INTO holder_debit_credit(cnic_no, trans_description, transaction_kind, amount)
VALUES (p_holderNo, CONCAT_WS(' ', 'Purchase return', p_description), 'debit', p_totalAmount);

-- Update the company account balance
UPDATE company_accounts SET balance = balance + p_totalAmount WHERE account_no = p_accountNumber;
...
END;
    ...
    -- Determine the supplier's name
    SET supplierName = (SELECT
                            CASE
                                WHEN pr.source_account_holder_id IS NOT NULL THEN ah.holder_name
                                WHEN pr.source_company_id IS NOT NULL THEN c.company_name
                            END
                        FROM purchase_requests pr
                            LEFT JOIN account_holders ah ON pr.source_account_holder_id = ah.cnic_no
                            LEFT JOIN companies c ON pr.source_company_id = c.company_id
                        WHERE pr.request_id = p_request_id);

    -- Insert stock arrival record
INSERT INTO stock_arrivals (request_id, arrive_date, wh_quantity, sh_quantity, vehicle_no, driver_no, product_code)
VALUES (p_request_id, NOW(), p_wh_quantity, p_sh_quantity, p_vehicle_no, p_driver_no, p_product_code);

-- Update Stock Level
UPDATE stock s
SET s.shop_quantity = s.shop_quantity + p_sh_quantity,
    s.warehouse_quantity = s.warehouse_quantity + p_wh_quantity
WHERE product_code = p_product_code;

-- Insert into product_ledger for shop quantity
IF p_sh_quantity > 0 THEN
        INSERT INTO product_ledger (product_code, transaction_type, quantity, location_type, `description`, transaction_date)
        VALUES (p_product_code, 'a', p_sh_quantity, 's', CONCAT('Stock arrived at shop from ', supplierName), NOW());
END IF;

    -- Insert into product_ledger for warehouse quantity
    IF p_wh_quantity > 0 THEN
        INSERT INTO product_ledger (product_code, transaction_type, quantity, location_type, `description`, transaction_date)
        VALUES (p_product_code, 'a', p_wh_quantity, 'w', CONCAT('Stock arrived at warehouse from ', supplierName), NOW());
END IF;
...
BEGIN
    DECLARE v_transactionType ENUM('debit', 'credit');
    DECLARE v_transactionDescription VARCHAR(200);

    -- Declare a handler for SQL exceptions
    DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
BEGIN
        -- Rollback the transaction if any SQL exception occurs
ROLLBACK;
-- Set the output parameter to false indicating failure
SET p_success = FALSE;
END;
...
-- Determine transaction type and description based on payment type
IF p_paymentType = 'debit' THEN
        SET v_transactionType = 'debit';
        SET v_transactionDescription = CONCAT('Payment made by cheque no: ', p_chequeNo);
ELSE
        SET v_transactionType = 'credit';
        SET v_transactionDescription = CONCAT('Credit entry for payment made by cheque no: ', p_chequeNo);
END IF;

    -- Update balance based on transaction type
    IF v_transactionType = 'debit' THEN
UPDATE company_accounts
SET balance = balance - p_amount
WHERE account_no = p_accountNo;
ELSE
UPDATE company_accounts
SET balance = balance + p_amount
WHERE account_no = p_accountNo;
...
INSERT INTO company_transactions (account_no, trans_description, transaction_type, amount)
VALUES (p_accountNo, v_transactionDescription, v_transactionType, p_amount);

-- Update payment status in empty_bills
UPDATE empty_bills
SET payment_status = 'Completed'
WHERE emp_bill_id = p_chequeNo;

-- Commit transaction if everything is successful
COMMIT;

-- Set the output parameter to true indicating success
SET p_success = TRUE;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_transfer_amount` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_transfer_amount`(
	IN p_sending_account VARCHAR(255),
    IN p_receiving_account VARCHAR(255),
    IN p_amount DOUBLE,
...
-- Subtract the amount from the sending account's balance
UPDATE company_accounts SET balance = balance - p_amount WHERE account_no = p_sending_account;

-- Add the amount to the receiving account's balance
UPDATE company_accounts SET balance = balance + p_amount WHERE account_no = p_receiving_account;

-- Insert a debit entry for the sending account
INSERT INTO company_transactions(account_no, transaction_type, amount, trans_description)
VALUES (p_sending_account, 'debit', p_amount, p_description);

-- Insert a credit entry for the receiving account
INSERT INTO company_transactions(account_no, transaction_type, amount, trans_description)
VALUES (p_receiving_account, 'credit', p_amount, p_description);
...
UPDATE holder_debit_credit
SET
    amount = p_amount
WHERE
    cnic_no = p_cnic_no AND trans_description = 'Closing balance.';
...
UPDATE stock
SET
    warehouse_quantity = p_wh_quantity,
    shop_quantity = p_sh_quantity
WHERE
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_software_password` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_software_password`(
	IN p_password VARCHAR(50),
    OUT result BOOLEAN
)
BEGIN
	DECLARE success BOOLEAN DEFAULT FALSE;
    -- Update the software password in the database
UPDATE admin_login
...
END IF;
    ...
    -- Set the result to indicate success or failure
    SET result = success;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
--
-- Final view structure for view `account_holder_report_view`
--
...
/*!50001 VIEW `account_holder_report_view` AS select `ah`.`holder_name` AS `holder_name`,`ah`.`is_retailer` AS `is_retailer`,ifnull((case when (`balances`.`balance` < 0) then 'Debit' else 'Credit' end),'Credit') AS `transaction_type`,abs(ifnull(`balances`.`balance`,0)) AS `balance` from (`account_holders` `ah` left join (select `dc`.`cnic_no` AS `cnic_no`,sum((case when (`dc`.`transaction_kind` = 'Debit') then -(`dc`.`amount`) when (`dc`.`transaction_kind` = 'Credit') then `dc`.`amount` else 0 end)) AS `balance` from `holder_debit_credit` `dc` group by `dc`.`cnic_no`) `balances` on((`ah`.`cnic_no` = `balances`.`cnic_no`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `stock_report_view` AS select `p`.`product_code` AS `product_code`,`p`.`product_name` AS `product_name`,`s`.`warehouse_quantity` AS `warehouse_quantity`,`s`.`shop_quantity` AS `shop_quantity` from ((((`products` `p` join `product_category` `pc` on((`p`.`category_id` = `pc`.`category_id`))) join `product_brand` `pb` on((`p`.`brand_id` = `pb`.`brand_id`))) join `companies` `c` on((`pb`.`company_id` = `c`.`company_id`))) join `stock` `s` on((`p`.`product_code` = `s`.`product_code`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-08-11 13:36:54
