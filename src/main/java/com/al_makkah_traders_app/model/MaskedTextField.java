...
public class MaskedTextField extends TextField {
    ...
    private void init() {
        ...
        this.plainTextProperty().addListener((observable, oldValue, newValue) -> this.updateSemanticMask(newValue));
    }
    ...
    private String valuesToString() {
        ...
        semanticMask.forEach(character -> value.append(character.getValue()));
